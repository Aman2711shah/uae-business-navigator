...
-- Priority 4: Secure freezone_public_info table
-- Add RLS to prevent unauthorized access to potentially sensitive freezone data
...
CREATE POLICY "Only admins can manage freezone public info" 
ON public.freezone_public_info 
FOR ALL 
USING (public.has_role(auth.uid(), 'admin'::app_role)) 
