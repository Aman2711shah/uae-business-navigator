...
import { z } from 'zod';
import { ArrowLeft, Check, User, Building, Globe, Users } from 'lucide-react';
...
export default function JoinCommunityForm({ industry, onBack, onSuccess }: JoinCommunityFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast({
        ...
        description: `You've successfully joined the ${industry} community.`,
      });
    ...
    <div className="min-h-screen bg-gradient-primary p-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Join {industry}</h1>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <Button 
                  ...
                  variant="cta"
                >
                  {isLoading ? "Joining..." : `Join ${industry} Community`}
                </Button>
              </form>
            </Form>
          </CardContent>
